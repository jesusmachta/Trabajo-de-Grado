            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    'Queremos expresar nuestro sincero agradecimiento a nuestro tutor académico y a todos los profesores de la Universidad Metropolitana que nos brindaron su apoyo y orientación durante el desarrollo de este proyecto.',
                    style: Theme.of(context).textTheme.bodyLarge,
                  ),
                  const SizedBox(height: 16),
                  Text(
                    'También agradecemos a Los Pomelos por permitirnos implementar y probar nuestro sistema en su establecimiento.',
                    style: Theme.of(context).textTheme.bodyLarge,
                  ),
                ],
              ),
